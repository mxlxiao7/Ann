 ...
 */
public class AIOFragment extends BaseFragment {

    private static final String TAG = AIOFragment.class.getSimpleName();
     ...
     * number.
     */
    public static AIOFragment newInstance() {
        AIOFragment fragment = new AIOFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_aio_layout, container, false);
